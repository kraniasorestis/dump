...
ael = ['alogaki', 'visini', 'larisa', 'larsa', 'aeltrakter', 'ael', 'aelara']
...
# 	global maxchar
# 	global minchar
# 	print "\nhow many characters should the words in the generated wordlist have?\nRemember WPA passwords are at least 8 characters long\n"
# 	minchar = input("minimum number of characters?  ")
# 	maxchar = input("maximum number of characters?  ")
...
def names():        # populates the nameslist
	...
	print "\n[+] names of partner, possible nicknames, relatives, pets or best friends - type 'end' to move on > "
	while True:
...
def add_(l):   # add the '_' character before the list's strings and reappend them to the list (to be used with years and sequences)
	tmp = []
	for i in l:
		tmp.append('_'+str(i))
	for i in tmp:
...
# paswdlength()    # ask the user how long the passwords should be
...
nameslist = dic_rep(nameslist, leet_basic)
